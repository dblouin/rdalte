...
public class NamedElementOperations extends ElementOperations {
	...
	public static String qualifiedName(NamedElement namedElement) {
		if ( namedElement.hasName() ) {
			return qualifiedName( namedElement, namedElement.getName() );
		}
...
//		}
	 ...
	 * @return
	 */
	public static String qualifiedName(	final NamedElement p_namedElement,
		...
		if ( namespace != null ) {
			...
			if ( namespace instanceof PackageSection && ( (AadlPackage) namespace.getOwner() ).hasName() ) {
				return ((AadlPackage) namespace.getOwner()).getName() + "::" + p_elemName;
			}
