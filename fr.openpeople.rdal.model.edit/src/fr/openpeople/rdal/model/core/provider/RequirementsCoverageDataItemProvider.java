...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal.model.core.RequirementsCoverageData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementsCoverageDataItemProvider
	 ...
	 * @generated
	 */
	public RequirementsCoverageDataItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.REQUIREMENTS_COVERAGE_DATA__NB_REQUIREMENTS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.REQUIREMENTS_COVERAGE_DATA__VERIFICATION_LEVEL,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns RequirementsCoverageData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RequirementsCoverageData"));
	}
	...
	public String getText(Object object) {
		String label = ((RequirementsCoverageData)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RequirementsCoverageData_type") :
			getString("_UI_RequirementsCoverageData_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RequirementsCoverageData.class)) {
