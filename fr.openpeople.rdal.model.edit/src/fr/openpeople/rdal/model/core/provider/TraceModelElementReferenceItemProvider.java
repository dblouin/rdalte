...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal.model.core.TraceModelElementReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceModelElementReferenceItemProvider
	extends ModelElementReferenceItemProvider
	implements
	 ...
	 * @generated
	 */
	public TraceModelElementReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TraceModelElementReference_container_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TraceModelElementReference_container_feature", "_UI_TraceModelElementReference_type"),
				 CorePackage.Literals.TRACE_MODEL_ELEMENT_REFERENCE__CONTAINER,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns TraceModelElementReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TraceModelElementReference"));
	}
	...
	public String getText(Object object) {
		String label = ((TraceModelElementReference)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TraceModelElementReference_type") :
			getString("_UI_TraceModelElementReference_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TraceModelElementReference.class)) {
