...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal.model.core.Assumption} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assumption_requirements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assumption_requirements_feature", "_UI_Assumption_type"),
				 CorePackage.Literals.ASSUMPTION__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assumption_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assumption_type_feature", "_UI_Assumption_type"),
				 CorePackage.Literals.ASSUMPTION__TYPE,
				 true,
				 false,
				 false,
