...
public abstract class AbstractRequirementCommand extends AbstractEditorCommand<AbstractRequirement> {

	public AbstractRequirementCommand( final EObject p_context ) {
		super( p_context );
	}
}
