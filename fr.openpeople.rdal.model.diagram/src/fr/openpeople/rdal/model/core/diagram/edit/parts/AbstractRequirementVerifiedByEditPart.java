...
import fr.openpeople.rdal.model.core.diagram.edit.policies.AbstractRequirementVerifiedByItemSemanticEditPolicy;

/**
 * @generated
 */
public class AbstractRequirementVerifiedByEditPart extends
	 ...
	 * @generated
	 */
	public AbstractRequirementVerifiedByEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AbstractRequirementVerifiedByItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new RequirementsVerificationActivityLink();
	}

	/**
	 * @generated
	 */
	public RequirementsVerificationActivityLink getPrimaryShape() {
		return (RequirementsVerificationActivityLink) getFigure();
	}

	/**
	 * @generated
	 */
	public class RequirementsVerificationActivityLink extends
			PolylineConnectionEx {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVerifiedByLabel;
		...
		private void createContents() {
			...
			fFigureVerifiedByLabel = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVerifiedByLabel() {
