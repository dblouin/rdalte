 ...
 * @generated
 */
public class RequirementRefinedByCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementRefinedByCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return RdalBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRequirementRefinedBy_4015(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getRefinedBy().add(getTarget());
		}
