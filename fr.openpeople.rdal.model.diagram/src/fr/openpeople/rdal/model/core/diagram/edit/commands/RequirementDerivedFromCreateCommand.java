 ...
 * @generated
 */
public class RequirementDerivedFromCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementDerivedFromCreateCommand(
	...
	public boolean canExecute() {
		...
		return RdalBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRequirementDerivedFrom_4014(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDerivedFrom().add(getTarget());
		}
