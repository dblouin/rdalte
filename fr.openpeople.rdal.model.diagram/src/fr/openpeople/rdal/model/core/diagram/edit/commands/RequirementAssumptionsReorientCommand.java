 ...
 * @generated
 */
public class RequirementAssumptionsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementAssumptionsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Assumption && newEnd instanceof Requirement)) {
			return false;
		}
		return RdalBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementAssumptions_4017(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return RdalBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementAssumptions_4017(getOldSource(),
						getNewTarget());
	}
