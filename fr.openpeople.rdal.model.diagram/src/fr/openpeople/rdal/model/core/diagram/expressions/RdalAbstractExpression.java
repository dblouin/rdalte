 ...
 * @generated
 */
public abstract class RdalAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = RdalDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RdalAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
