 ...
 * @generated
 */
public class RequirementsGroupCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RequirementsGroupCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		RequirementsGroup newElement = CoreFactory.eINSTANCE
				.createRequirementsGroup();

		Specification owner = (Specification) getElementToEdit();
		owner.getRequirementGroups().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(RequirementsGroup newElement,
