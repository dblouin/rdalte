 ...
 * @generated
 */
public class StakeHolderNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				RdalVisualIDRegistry
						.getType(fr.openpeople.rdal.model.core.diagram.edit.parts.StakeHolderNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public StakeHolderNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RdalTextSelectionEditPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return RdalElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof RdalTextSelectionEditPolicy) {
			((RdalTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof RdalTextSelectionEditPolicy) {
			((RdalTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RdalParserProvider
					.getParser(
							RdalElementTypes.StakeHolder_2011,
							getParserElement(),
							RdalVisualIDRegistry
									.getType(fr.openpeople.rdal.model.core.diagram.edit.parts.StakeHolderNameEditPart.VISUAL_ID));
		}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					RdalEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
