...
import fr.openpeople.rdal.model.core.diagram.edit.policies.RequirementItemSemanticEditPolicy;
...
public class RequirementEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof RequirementTypeEditPart) {
			((RequirementTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRequirementNameFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(RdalElementTypes.RequirementDerivedFrom_4014);
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof fr.openpeople.rdal.model.core.diagram.edit.parts.RequirementEditPart) {
			types.add(RdalElementTypes.AbstractRequirementContainedRequirements_4016);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		} else if (relationshipType == RdalElementTypes.RequirementDerivedFrom_4014) {
			types.add(RdalElementTypes.Requirement_3003);
	...
	public class RequirementFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureTypeFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureRequirementNameFigure;
		...
		private void createContents() {
			...
			fFigureTypeFigure = new WrappingLabel();
			fFigureTypeFigure.setText("");
			fFigureTypeFigure.setAlignment(PositionConstants.CENTER);

			fFigureTypeFigure.setFont(FFIGURETYPEFIGURE_FONT);

			this.add(fFigureTypeFigure);

			fFigureRequirementNameFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTypeFigure() {
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRequirementNameFigure() {
	 ...
	 * @generated
	 */
	static final Font FFIGURETYPEFIGURE_FONT = new Font(Display.getCurrent(),
			"sansserif", 8, SWT.ITALIC);
