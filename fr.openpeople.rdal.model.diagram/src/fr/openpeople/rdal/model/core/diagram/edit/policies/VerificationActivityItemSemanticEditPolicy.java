 ...
 * @generated
 */
public class VerificationActivityItemSemanticEditPolicy extends
		RdalBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public VerificationActivityItemSemanticEditPolicy() {
		super(RdalElementTypes.VerificationActivity_2010);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RdalVisualIDRegistry.getVisualID(incomingLink) == AbstractRequirementVerifiedByEditPart.VISUAL_ID) {
